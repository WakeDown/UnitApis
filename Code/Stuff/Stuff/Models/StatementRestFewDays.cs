...
namespace Stuff.Models
{
    public class StatementRestFewDays:Statement
    {
        ...
        public void Configure()
        {
            ...
            if (Employee.Manager.Id != dir.Id) Matchers.Add(dir);
            ...
            {
                Text = String.Format("Прошу предоставить мне отпуск без сохранения заработной платы в количестве {0} календарных дней {1:dd.MM.yyyy} г., {2}.", DaysCount, DateStart, Cause);
            }
            else
            {
