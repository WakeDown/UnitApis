...
namespace DataProvider.Helpers
{
    public class MathHelper
    {
        ...
        private static readonly byte[] initVectorBytes = Encoding.ASCII.GetBytes("1@#45Un1tGroup!A");
        ...
        //public static string EncodePassword(string passStr, string salt)
        //{
        //    byte[] cipherBytes = Convert.FromBase64String(passStr);
        ...
        //                cs.Close();
        //            }
        //            passStr = Encoding.Unicode.GetString(ms.ToArray());
        //        }
        //    }
        //    return passStr;
        ...
        //public static string DecodePassword(string passEncoded, string salt)
        //{
        //    byte[] cipherBytes = Convert.FromBase64String(passEncoded);
        //    using (Aes encryptor = Aes.Create())
        //    {
        //        Rfc2898DeriveBytes pdb = new Rfc2898DeriveBytes(salt, new byte[] { 0x49, 0x76, 0x61, 0x6e, 0x20, 0x4d, 0x65, 0x64, 0x76, 0x65, 0x64, 0x65, 0x76 });
        //        encryptor.Key = pdb.GetBytes(32);
        ...
        //                cs.Close();
        //            }
        //            passEncoded = Encoding.Unicode.GetString(ms.ToArray());
        //        }
        //    }
        //    return passEncoded;

        //    //return passEncoded.Remove(0, salt.Count());
        //}
    }
}